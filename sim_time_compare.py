...
np.savetxt('time-reg.csv', reg_error, delimiter=", ")
np.savetxt('time-regwm.csv', reg_error_wm, delimiter=", ")
np.savetxt('time-drl.csv', opedr_error, delimiter=", ")
np.savetxt('time-drlwm.csv', opedr_error_wm, delimiter=", ")
np.savetxt('time-is.csv', is_opedr_error, delimiter=", ")
np.savetxt('time-iswm.csv', is_opedr_error_wm, delimiter=", ")
np.savetxt('time-trl.csv', opeuc_error, delimiter=", ")

...
np.savetxt('trajectory-reg.csv', reg_error, delimiter=", ")
np.savetxt('trajectory-regwm.csv', reg_error_wm, delimiter=", ")
np.savetxt('trajectory-drl.csv', opedr_error, delimiter=", ")
np.savetxt('trajectory-drlwm.csv', opedr_error_wm, delimiter=", ")
np.savetxt('trajectory-is.csv', is_opedr_error, delimiter=", ")
np.savetxt('trajectory-iswm.csv', is_opedr_error_wm, delimiter=", ")
np.savetxt('trajectory-trl.csv', opeuc_error, delimiter=", ")

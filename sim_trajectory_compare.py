...
# qlearner_setting = {'epoch': 100, 'trace': False, 'rbf_dim': [5], 'verbose': True, 'model': 'linear', 'eps': 1e-12}
...
# wm_qlearner_setting = {'epoch': 100, 'trace': False, 'rbf_dim': [10], 'verbose': True, 'model': 'linear', 'eps': 1e-12}
# wm_ratiolearner_setting = {'mode': 'linear', 'rbf_ndims': [10], 'batch_size': 32, 'epoch': 3, 'lr': 0.01, 'verbose': True}
palearner_setting = {'discrete_state': False, 'rbf_dim': [1, 2, 3, 4, 5], 'cv_score': 'accuracy', 'verbose': True}
pmlearner_setting = {'discrete_state': False, 'discrete_action': False, 'rbf_dim': [1, 2, 3, 4, 5], 'cv_score': 'accuracy', 'verbose': True}
# qlearner_setting = {'epoch': 100, 'trace': False, 'rbf_dim': [1, 3, 5, 7, 9], 'verbose': True, 'model': 'linear', 'eps': 1e-12}
qlearner_setting = {'epoch': 100, 'trace': False, 'rbf_dim': [20], 'verbose': True, 'model': 'linear', 'eps': 1e-12}
# ratiolearner_setting = {'mode': 'linear', 'rbf_ndims': [1, 3, 5, 7, 9], 'batch_size': 32, 'epoch': 3, 'lr': 0.01, 'verbose': True}
ratiolearner_setting = {'mode': 'linear', 'rbf_ndims': [150], 'batch_size': 32, 'epoch': 3, 'lr': 0.01, 'verbose': True}
wm_palearner_setting = {'discrete_state': False, 'rbf_dim': [1, 2, 3, 4, 5], 'cv_score': 'accuracy', 'verbose': True}
wm_qlearner_setting = {'epoch': 100, 'trace': False, 'rbf_dim': [1, 3, 5, 7, 9], 'verbose': True, 'model': 'linear', 'eps': 1e-12}
wm_ratiolearner_setting = {'mode': 'linear', 'rbf_ndims': [1, 3, 5, 7, 9], 'batch_size': 32, 'epoch': 3, 'lr': 0.01, 'verbose': True}
...
for i, num_trajectory in enumerate(num_trajectory_list):
    ...
    for k, r in enumerate(seed_list):
        if r % 10 == 0:
            logging.info("Remain {0}%.".format(100 - r))
        pass
...
np.savetxt('trajectory-reg-cover-dim-1.csv'.format(state_dim), reg_cover, delimiter=", ")
np.savetxt('trajectory-regwm-cover-dim-1.csv'.format(state_dim), reg_wm_cover, delimiter=", ")
np.savetxt('trajectory-drl-cover-dim-1.csv'.format(state_dim), opedr_cover, delimiter=", ")
np.savetxt('trajectory-drlwm-cover-dim-1.csv'.format(state_dim), opedr_wm_cover, delimiter=", ")
np.savetxt('trajectory-is-cover-dim-1.csv'.format(state_dim), is_opedr_cover, delimiter=", ")
np.savetxt('trajectory-iswm-cover-dim-1.csv'.format(state_dim), is_opedr_wm_cover, delimiter=", ")
np.savetxt('trajectory-trl-cover-dim-1.csv'.format(state_dim), opeuc_cover, delimiter=", ")
